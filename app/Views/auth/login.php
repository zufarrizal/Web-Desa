...
<head>
    <?php
    $metaTitle = 'Login - Portal Desa';
    $metaDescription = 'Masuk ke Portal Desa untuk mengakses layanan administrasi warga dan dashboard pengguna.';
                    ...
                    <div class="card-body">
                        ...
                        <form id="loginForm" method="post" action="<?= site_url('login') ?>" autocomplete="off">
                            ...
                            <?php if (! empty($recaptchaEnabled) && ! empty($recaptchaSiteKey)) : ?>
                                <input type="hidden" name="g-recaptcha-response" id="recaptchaResponseLogin" value="">
                        ...
                        <div class="authent-reg mt-3">
                            <p>Belum punya akun warga? <a href="<?= site_url('register') ?>">Daftar sekarang</a></p>
                            <p><a href="<?= site_url('forgot-password') ?>">Lupa password?</a></p>
                        </div>
    ...
    <?php if (! empty($recaptchaEnabled) && ! empty($recaptchaSiteKey)) : ?>
        ...
        <script>
            (function () {
                ...
                var tokenInput = document.getElementById('recaptchaResponseLogin');
                if (!form || !tokenInput) {
                    return;
                }
